        ...
        <div className="about-vision">
          <div className="vision-content">
            <article className="header">
              <h3>
                Know what you paying for when <br /> servicing and spares your
                car
              </h3>
              <p>
                Aatumate is set to transform the way car owners discover and
                engage with trustworthy workshops and mechanics.By utilizing our
                online portal, customers can effortlessly connect with reliable
                workshops in their local area, saving them valuable time and
